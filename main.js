...
document.getElementById("drawn_sketch").innerHTML="Sketch to be drawn : "+Element_of_array;
...
function updateCanvas(){
    ...
    random_no = Math.floor((Math.random()*quick_draw_data_set.length)+1);
    Element_of_array = quick_draw_data_set[random_no];
    document.getElementById("your_sketch").innerHTML = "sketch to be drawn : "+ Element_of_array;
}